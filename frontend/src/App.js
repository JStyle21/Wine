          ...
          <Grid container spacing={1.5}>
            ...
            {formData.type === 'Wine' && (
              <>
                <Grid item xs={12}>
                  <FormControl fullWidth size="small">
                    <InputLabel sx={{ '&&.MuiInputLabel-shrink': { right: '234px !important', left: 'auto !important' } }}>סוג יין</InputLabel>
            ...
            <Grid item xs={6}>
              <TextField
                ...
                onChange={handleChange}
                InputLabelProps={{ shrink: true, sx: { '&&.MuiInputLabel-shrink': { right: '184px !important', left: 'auto !important' } } }}
                inputProps={{ style: { textAlign: 'right' } }}
              />
            </Grid>
